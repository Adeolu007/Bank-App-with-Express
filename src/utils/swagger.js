...
const swaggerOptions = {
    swaggerDefinition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description: `
    This API provides a comprehensive interface for managing banking transactions and user accounts within the Adeolu application. 
    ...
    The API also adheres to OpenAPI specifications, allowing developers to easily understand and use the endpoints provided. 
    Comprehensive error handling and response formatting are implemented to provide meaningful feedback for different scenarios.

    For detailed usage instructions, please refer to the [API Documentation](http://localhost:3000/api-docs).
  `,
        },
        servers: [
            {
